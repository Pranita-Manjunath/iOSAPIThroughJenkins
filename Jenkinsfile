    ...
    stages{
        stage('Build') {
            steps {
                ...
                sh 'xcodebuild -exportArchive -archivePath build/Runner.xcarchive -exportPath build/NewFolder/Runner.ipa -exportOptionsPlist build/NewFolder/ExportOptions.plist'
                }
            }
        }
}